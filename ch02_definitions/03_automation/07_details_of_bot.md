...
_Choose Social Media Platform: <a href='../../../bsky/ch02_definitions/03_automation/07_details_of_bot.html'>Bluesky</a> | <a href='../../../reddit/ch02_definitions/03_automation/07_details_of_bot.html'>Reddit</a> | <a href='../../../discord/ch02_definitions/03_automation/07_details_of_bot.html'>Discord</a> | __Mastodon__ | <a href='../../../nocode/ch02_definitions/03_automation/07_details_of_bot.html'>No Coding</a>_
...
mastodon = Mastodon(
    ...
    access_token = "<strong style="color:black;background-color:lightgreen">m#5@_fake_access_token_$%Ds</strong>")
...
The next section of code is these few lines:
```python
mastodon = Mastodon(
    api_base_url = "https://mastodon.social", 
    access_token = "m#5@_fake_access_token_$%Ds")
